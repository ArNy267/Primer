 ...
 * @var array
 */
	public $belongsTo = array( //many to one		Many recipes belong to a user.
		'Empresa' => array(
			'className' => 'Empresa',
 ...
 * @var array
 */
	public $hasMany = array( //one to many		A user can have multiple recipes.
		'Negociacion' => array(
		...
		'UsuariosSkill',
		 # verificar si la conexion esta correcta !!!!.......
		'Conexion' => array(
			'className' => 'Conexion',
			'foreignKey' => 'id',
			'conditions' => '',
