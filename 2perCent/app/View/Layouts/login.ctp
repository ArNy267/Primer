...
<?php echo $title_for_layout; ?>
    ...
    <body>
        <div class="header" id="header">
            <div class="container">
                <div class="pull-left"> 
                    <?php echo $this->html->image('logo.png', array( 'url' => array( 'controller' => 'Usuarios', 'action' => 'index')));  ?> 
                </div>
                <div class="pull-right span10">
                    <div class="pull-left span3">
                        <div class="nav"> 
                    <!--    <a href="#">Account</a> <a href="#">herramientas</a> -->
                        </div>
                    </div>
                    <div class="pull-left span2">
                        <div class="set_box dropdown"> <!--
                            ...
                            <a data-toggle="dropdown" href="#" >
                                <?php   //echo $usuario_logged_nombre . ' ' . $usuario_logged_apellido; ?> 
                                <i class="downarrow" > </i>
                            </a>
                            <ul aria-labelledby="dLabel" role="menu" class="dropdown-menu">
                                <li class="first">
                                    <?php // echo $this->html->image('settings_icon2.png'); ?>
                                    <?PHP // echo $this->Html->link($this->Html->tag('span', __('Settings', true)), array('controller' => 'usuarios', 'action' => 'index'), array( 'escape' => false));     ?>
                                    <!-- <img alt="" src="images/settings_icon2.png"> 
                                </li>
                                <li>
                                    <?php // echo $this->html->image('user_icon.png'); ?>
                                    <?php // echo $this->Html->link($this->Html->tag('span', __('Profile', true)), array('controller' => 'usuarios', 'action' => 'view', $usuario_logged_id), array(  //'escape' => false));  ?>
                                     <!-- <img alt="" src="images/user_icon.png"> 
                                </li>
                                <li class="last">
                                    <?php // echo $this->html->image('logout_icon.png'); ?>
                                    <?php // echo $this->Html->link($this->Html->tag('span', __('Logout', true)), array('controller' => 'usuarios', 'action' => 'logout'), array('escape' => false)); ?>
                ...
                <!--    <div class="pull-left badge-main span"> 
                        <a  href="#"> <?php  echo $this->html->image('top-icon1.png', array( 'class' => 'fl',  )); ?>
                                  
                                <!-- <img class="fl" alt="" src="images/top-icon1.png">  
                            <div class="badge fl push-upside-bage">23 </div>
                        </a> 
                        <a  href="#"> <?php
                                    echo $this->html->image('top-icon2.png', array( 'class' => 'fl', ));   ?>
