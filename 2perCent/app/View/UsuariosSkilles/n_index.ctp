<div class="usuariosSkilles index">
	<h2><?php echo __('Usuarios Skilles'); ?></h2>
	...
	<?php foreach ($usuariosSkilles as $usuariosSkill): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $usuariosSkill['UsuariosSkill']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $usuariosSkill['UsuariosSkill']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $usuariosSkill['UsuariosSkill']['id']), null, __('Are you sure you want to delete # %s?', $usuariosSkill['UsuariosSkill']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
