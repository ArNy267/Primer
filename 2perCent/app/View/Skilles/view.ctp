...
<h2><?php echo __('Skill'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($skill['Skill']['nombre']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Anios'); ?></dt>
		<dd>
			<?php echo h($skill['Skill']['anios']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Descripcion'); ?></dt>
		<dd>
			<?php echo h($skill['Skill']['descripcion']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php foreach ($skill['Usuario'] as $usuario): ?>
		<tr>
