<div class="skilles index">
	<h2><?php echo __('Skilles'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('nombre'); ?></th>
			<th><?php echo $this->Paginator->sort('anios'); ?></th>
			<th><?php echo $this->Paginator->sort('descripcion'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($skilles as $skill): ?>
	<tr>
		<td><?php echo h($skill['Skill']['id']); ?>&nbsp;</td>
		<td><?php echo h($skill['Skill']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($skill['Skill']['anios']); ?>&nbsp;</td>
		<td><?php echo h($skill['Skill']['descripcion']); ?>&nbsp;</td>
		<td class="actions">
